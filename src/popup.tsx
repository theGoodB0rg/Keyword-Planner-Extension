...
const Container = styled.div`
  ...
  max-width: 100%;
  overflow-x: hidden;
  min-width: 480px; /* Slightly increased min-width */
`;
...
const ButtonContainer = styled.div`
  ...
  margin-bottom: 1rem;
  flex-wrap: wrap; /* Allow buttons to wrap on smaller widths if needed */
  gap: 8px; /* Add spacing between buttons that will wrap */
`;
